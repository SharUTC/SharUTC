...
public interface IntegrateRemoteCatalogCommand extends Command {
    ...
    /**
     *
     * Gets the catalog which will be integrated to the appModel's remote catalog when the command is executed.
     * 
     * @return
     */
    ...
    /**
     *
     * Sets the catalog which will be integrated to the appModel's remote catalog when the command is executed.
     * 
     * @param catalog
     */
