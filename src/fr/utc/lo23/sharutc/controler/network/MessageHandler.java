...
public interface MessageHandler {
    ...
    /**
     * Sets the previousMessageType attribute with type of latest message (with
     * conversationId) sent
     *
    ...
    /**
     * Gets the previousMessageType attribute which contains type of latest
     * message (with conversationId) sent
     *
