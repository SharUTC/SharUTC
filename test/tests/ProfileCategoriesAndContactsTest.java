...
public class ProfileCategoriesAndContactsTest {
    ...
    public void createCategoryCommand() {
        ...
        Assert.assertNotEquals("createCategoryCommand failed : the categorie amis is added twice", 2,
                appModel.getProfile().getCategories().getCategories().size());
    ...
    public void deleteCategoryCommand() {
        ...
        Assert.assertEquals("deleteCategoryCommand failed : the categry is not deleted",
                appModel.getProfile().getCategories().getCategories().size(),0);
